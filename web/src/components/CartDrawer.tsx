...
const CartDrawer = () => {
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <header className="px-8 py-6 flex items-center justify-between border-b border-outline-variant/30">
                ...
                <div className="flex flex-col flex-1 py-1">
                  ...
                  <div className="mt-auto flex justify-between items-center">
                    <div className="flex items-center border border-outline-variant/40">
                      <button className="px-3 py-1 text-on-surface-variant hover:text-on-surface hover:bg-surface-container-low transition-colors">-</button>
        ...
        {cart && cart.lines.edges.length > 0 && (
          <div className="p-8 border-t border-outline-variant/30 bg-surface">
            <div className="flex justify-between items-end mb-6 text-on-surface">
            ...
            <p className="text-xs font-label text-on-surface-variant tracking-wide mb-6">
